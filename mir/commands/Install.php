...
class Install extends Command
{
    protected function configure()
    {
        $this->setName('install')
            ...
            ->addArgument('lang', InputArgument::REQUIRED, 'Enter language ('.implode('/', Mir::LANGUAGES).')')
            ...
            ->addArgument('mir_host', InputArgument::REQUIRED, 'Enter mir host')

            ->addArgument('user_login', InputArgument::OPTIONAL, 'Enter mir admin login', 'admin')
            ->addArgument('user_pass', InputArgument::OPTIONAL, 'Enter mir admin password', '1111')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!in_array($confs['lang'], Mir::LANGUAGES)) {
        ...
        $confs['host'] = $input->getArgument('mir_host');
        ...
        $MirInstall = new MirInstall($confs, 'admin', $output);
