...
class MirJsonParcer
{
     ...
     * @var int
     */
    protected $unicodeHighSurrogate = -1;
    ...
    protected function checkAndSkipUtfBom(string $c): bool
    {
    ...
    protected function startObject(): void
    {
    ...
    protected function endObject(): void
    {
        $popped = array_pop($this->stack);
    ...
    protected function startString(): void
    {
        $this->stack[] = self::STACK_STRING;
        $this->state = self::STATE_IN_STRING;
    }

    protected function startKey(): void
    {
     ...
     * @throws ParsingException
     */
    protected function processEscapeCharacter(string $c): void
    {
        if ('"' === $c) {
            $this->buffer .= '"';
        } elseif ('\\' === $c) {
     ...
     * @throws ParsingException
     */
    protected function processUnicodeCharacter(string $char): void
    {
    ...
    protected function endUnicodeSurrogateInterstitial(): void
    {
    ...
    protected function endUnicodeCharacter(int $codepoint): void
    {
    ...
    protected function startNumber(string $c): void
    {
        $this->state = self::STATE_IN_NUMBER;
        $this->buffer .= $c;
    }

    protected function endNumber(): void
    {
    ...
    protected function endTrue(): void
    {
        $this->endSpecialValue(true, 'true');
    }

    protected function endFalse(): void
    {
        $this->endSpecialValue(false, 'false');
    }

    protected function endNull(): void
    {
        $this->endSpecialValue(null, 'null');
    }

    protected function endSpecialValue($value, string $stringValue): void
    {
