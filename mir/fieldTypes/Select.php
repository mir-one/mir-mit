...
use mir\common\calculates\CalculateSelectPreview;
use mir\common\calculates\CalculateSelectValue;
use mir\common\calculates\CalculateSelectViewValue;
    ...
    public function getPreviewHtml($val, $row, $tbl, $withNames = false)
    {
        ...
        try {
            ...
            foreach ($row['__fields'] ?? [] as $name => $field) {
                ...
                //string, url, currency, css, xml, text, html, json, mir, javascript
            }
