...
<head lang="ru">
    ...
    <title><?= !empty($title) ? $title . ' — ' : '' ?>Mir</title>
    <?php
    $host = 'http' . (!empty($_SERVER['HTTPS']) ? 's' : '') . '://' . $_SERVER['HTTP_HOST'] . '/';
    ?>
    <meta name="viewport" content="width=900, user-scalable=no">
    <meta property="og:image" content="<?= $host ?>imgs/mir.png"/>
    <meta property="og:url" content="<?= $host ?>"/>
    <meta property="og:title" content="Mir — платформа для любой автоматизации в малом бизнесе"/>
    <meta property="og:description"
          content="Mir — платформа для любой автоматизации в малом бизнесе. На ней можно собирать заточенные под клиента базы данных с готовым интерфейсом и настраиваемым доступом, узкоспециальные CRM, склады, расчеты и все, что придет в голову"/>
</head>
<body id="pk"
      class="lock">
<noscript>
